...
To view your website, type your repository name into the address bar (in my case, segregationbeyondlaw.github.io). The finished product should look something like this:
